// contendra todos ads que se estaran mostrando
const ALL_ADS = [
   {
...
class Ads{
   ...
   _initAds(){
      // dejamos caer todos los datos del array a otro
      this._ads = [...ALL_ADS] //creamos una copia del array original
   }

   getAds(){
      if(this._ads.length === 0){
         this._initAds() //si ya no hay nada en la copia para mostrar reiniciamos
      }
      return this._ads.pop() //sacamos un valor del array y nos elimina
   }
